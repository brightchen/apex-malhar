...
public class SerialToLVBufferTest
{
  ...
  {
    SerdeCollectionWithSerializeBuffer<String, List<String>> listSerde = new SerdeCollectionWithSerializeBuffer<>(
        new SerdeStringWithSerializeBuffer());
    listSerde.setCollectionClass((Class)ArrayList.class);
