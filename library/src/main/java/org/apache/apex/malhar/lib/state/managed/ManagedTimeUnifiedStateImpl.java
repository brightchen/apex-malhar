...
public class ManagedTimeUnifiedStateImpl extends AbstractManagedStateImpl implements BucketedState
{
  ...
  {
    Preconditions.checkArgument(buckets.get(bucketIdx).getBucketId() < newBucketId, "new time bucket should have a value"
    ...
    bucketsForTeardown.add(buckets.get(bucketIdx));
    buckets.put(bucketIdx, newBucket(newBucketId));
    buckets.get(bucketIdx).setup(this);
  }
  ...
  public void setup(Context.OperatorContext context)
  {
    ...
    if (timeBucketAssigner == null) {
      ...
      //unBoundedTimeBucketAssigner.setup(context);
      unBoundedTimeBucketAssigner.setPurgeListener(this);
