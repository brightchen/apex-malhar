 ...
 *
 */
public class SerializeSlice extends Slice
{
  private static final long serialVersionUID = -471209532589983329L;

  //for kyro
  protected SerializeSlice()
  {
    //the super class's default constructor is private and can't called.
    super(null, 0, 0);
  }

  public SerializeSlice(byte[] array, int offset, int length)
  {
    super(array, offset, length);
  }

  public SerializeSlice(byte[] array)
  {
    super(array);
  }

  public SerializeSlice(Slice netletSlice)
  {
